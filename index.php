...
// For root access, serve the HTML page
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>🛍️ Fortes E-commerce Store</title>
...
<body>
    ...
    <div class="app-container" id="appContainer">
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="header-actions">
                        <button class="filter-btn" onclick="openFilters()"><i class="fas fa-filter"></i></button>
                ...
                <div class="container">
                    <div class="banner-content">
                        <div class="banner-text">
                            <h1>Special</h1>
                            <h2>OFFER</h2>
                            <p>Get amazing deals on your favorite products. Limited time offer!</p>
                            <button class="btn-primary">Shop Now</button>
                        </div>
                        <div class="banner-image">
                            <img src="photo_ecommerce/Apple_Laptop.jpg" alt="Featured Product" onerror="this.src='https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500'">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="trending-products">
                <div class="container">
                    <div class="section-header">
                        ...
                        <button class="view-all" onclick="showPage('products')">View All</button>
                    </div>
        ...
        <div id="searchPage" class="page">
            <div class="container">
                <div class="search-header">
                    <h2 class="page-title" id="searchTitle">Search Results</h2>
                    <div class="search-filters">
                ...
                <div class="recent-searches">
                    ...
                    <div class="recent-search-tags">
                        <span class="search-tag">laptop</span>
                        <span class="search-tag">headphones</span>
                        <span class="search-tag">coffee mug</span>
                    </div>
                </div>
